...
def my_print(args):
		#print("SSHClient: %s" % str(args))
		logger.debug("SSHClient: %s" % str(args))
    ...
    def __init__(self, hostname, username, password, port=22):
        ...
        try:
            ...
            my_print(self.session.last_error())
						...
						my_print("error")
						my_print(e)
						my_print("Error connecting SSH user=%s , host=%s, port=%d:, error: %s" % (username,hostname,port,str(e)) )
